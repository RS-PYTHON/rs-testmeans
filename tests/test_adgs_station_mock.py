...
def test_basic_auth(adgs_client, external_auth_config, app_header):
    ...
    assert (
        adgs_client.get("/", headers={"Authorization": f"Token {wrong_token_info['access_token']}"}).status_code
...
def test_query_products(adgs_client_with_auth, products_response):
    ...
    top_pagination = "3"
    # filter&top
    endpoint = f'Products?$filter="PublicationDate gt 2014-01-01T12:00:00.000Z and PublicationDate lt 2023-12-30T12:00:00.000Z&$top={top_pagination}'  # noqa: E501 # pylint: disable=line-too-long
    response = adgs_client_with_auth.get(endpoint)
    print(response)
    assert len(json.loads(response.text)["value"]) == int(top_pagination)
    # top&filter
    endpoint = f'Products?$top={top_pagination}&$filter="PublicationDate gt 2014-01-01T12:00:00.000Z and PublicationDate lt 2023-12-30T12:00:00.000Z'  # noqa: E501 # pylint: disable=line-too-long
    response = adgs_client_with_auth.get(endpoint)
    assert len(json.loads(response.text)["value"]) == int(top_pagination)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "Products?$filter=contains(Name, 'S2__OPER_AUX_ECMWFD_PDMC_20190216T120000_V20190217T090000_20190217T210000.TGZ') and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'productType' and att/OData.CSC.StringAttribute/Value eq 'OPER_AUX_ECMWFD_PDMC')",  # noqa: E501 # pylint: disable=line-too-long
            True,
        ),
        (
            "Products?$filter=contains(Name, 'NOT_FOUND.TGZ') and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'productType' and att/OData.CSC.StringAttribute/Value eq 'OPER_AUX_ECMWFD_PDMC')",  # noqa: E501 # pylint: disable=line-too-long
            False,
        ),
        (
            "Products?$filter=contains(Name, 'S2__OPER_AUX_ECMWFD_PDMC_20190216T120000_V20190217T090000_20190217T210000.TGZ') and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'productType' and att/OData.CSC.StringAttribute/Value eq 'INVALID_TYPE')",  # noqa: E501 # pylint: disable=line-too-long
            False,
        ),
        (
            "Products?$filter=Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'productType' and att/OData.CSC.StringAttribute/Value eq 'OPER_AUX_ECMWFD_PDMC') and contains(Name, 'S2__OPER_AUX_ECMWFD_PDMC_20190216T120000_V20190217T090000_20190217T210000.TGZ')",  # noqa: E501 # pylint: disable=line-too-long
            True,
        ),
        (
            "Products?$filter=PublicationDate gt 2014-01-01T12:00:00.000Z and PublicationDate lt 2023-12-30T12:00:00.000Z and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'productType' and att/OData.CSC.StringAttribute/Value eq 'OPER_AUX_ECMWFD_PDMC')",  # noqa: E501 # pylint: disable=line-too-long
            True,
        ),
        # Invalid publicationdate
        (
            "Products?$filter=PublicationDate gt 2030-01-01T12:00:00.000Z and PublicationDate lt 2023-12-30T12:00:00.000Z and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'productType' and att/OData.CSC.StringAttribute/Value eq 'OPER_AUX_ECMWFD_PDMC')",  # noqa: E501 # pylint: disable=line-too-long
            False,
        ),
        # Reverse order
        (
            "Products?$filter=Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'productType' and att/OData.CSC.StringAttribute/Value eq 'OPER_AUX_ECMWFD_PDMC') and PublicationDate gt 2014-01-01T12:00:00.000Z and PublicationDate lt 2023-12-30T12:00:00.000Z",  # noqa: E501 # pylint: disable=line-too-long
            True,
        ),
        (
            "Products?$filter=contains(Name, 'S1A_OPER_MPL_ORBSCT_20210902T150704_99999999T999999_0025.EOF') and PublicationDate gt 2020-01-01T00:00:00.000Z and PublicationDate lt 2024-01-01T00:00:00.000Z",  # noqa: E501 # pylint: disable=line-too-long
            True,
        ),
        (
            "Products?$filter=contains(Name, 'S1A_OPER_MPL_ORBSCT_20240514T150704_99999999T999999_0025.EOF') and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'productType' and att/OData.CSC.StringAttribute/Value eq 'OPER_MPL_ORBSCT') and Attributes/OData.CSC.StringAttribute/any(att:att/Name eq 'platformShortName' and att/OData.CSC.StringAttribute/Value eq 'sentinel-1')&$orderby=PublicationDate desc&$top=10000&$skip=0&$expand=Attributes",  # noqa: E501 # pylint: disable=line-too-long
            True,
        ),
        (
            "Products?$filter=contains(Name, 'S1A_OPER_MPL_ORBSCT_20240514T150704_99999999T999999_0025.EOF') and PublicationDate gt 2024-05-13T23:59:59.000Z and PublicationDate lt 2024-05-14T00:00:01.000Z&$orderby=PublicationDate desc&$top=10000&$skip=0&$expand=Attributes",  # noqa: E501 # pylint: disable=line-too-long
            True,
        ),
        (
